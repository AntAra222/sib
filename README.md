...
Fork the following GitHub repository: https://github.com/diogomcachetas/sib.git
...
```bash
git remote add upstream https://github.com/diogomcachetas/sib.git
...
## Credits
João Capela, Fernando Cruz, Vítor Pereira and João Correia for the original implementation.
